...
arch="x86_64"
url="https://github.com/chungjon/alpine-pkg-glibc"
license="LGPL"
source="https://github.com/chungjon/docker-glibc-builder/releases/download/$pkgver-$_pkgrel/glibc-bin-$pkgver-$_pkgrel-x86_64.tar.gz
nsswitch.conf
ld.so.conf"
